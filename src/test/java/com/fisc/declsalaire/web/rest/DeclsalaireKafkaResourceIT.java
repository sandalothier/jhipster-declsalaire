...
import com.fisc.declsalaire.DeclsalaireApp;
...
@SpringBootTest(classes = DeclsalaireApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DeclsalaireKafkaResourceIT {
    ...
    @Autowired
    private DeclsalaireKafkaProducer producer;

    @Autowired
    private DeclsalaireKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclsalaireKafkaResource kafkaResource = new DeclsalaireKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declsalaire-kafka/publish?message=test"))
